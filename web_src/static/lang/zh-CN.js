...
exports.default = {
  ...
  section_description7_2:
    '你可以选择将vmingpian.vip/doc部署到你的服务器',
  section_title8: '在线托管',
  section_description8_1:
    'vmingpian.vip/doc 安全稳定的在线文档托管服务',
  section_description8_2:
    '你可以放心地选择托管你的文档数据在云端',
  section_title9: '立即体验',
  section_description9: '超过100000+互联网团队正在使用',
  ...
  open_api_tips1:
    '开放文档编辑的API，供使用者更加方便地操作文档数据。<br>利用开放API，你可以自动化地完成很多事',
  open_api_tips2:
    '如果你想自动化生成API文档，则可参考<a target="_bank" href="https://vmingpian.vip/page/741656402509783">API文档</a>',
  open_api_tips3:
    '如果你想自动化生成数据字典，则可参考<a target="_bank" href="https://vmingpian.vip/page/312209902620725">数据字典</a>',
  open_api_tips4:
    '如果你更自由地生成自己所需要的格式，则可参考<a target="_bank" href="https://vmingpian.vip/page/102098">开放API</a>',
  ...
  long_page_tips:
    '检测到本页面内容比较多，暂时关闭了html实时预览功能，以防止过多内容造成页面卡顿。你可以在编辑栏中找到预览按钮进行手动打开。',
  ...
  cat_tips: '可拖动以排序',
  cat_limite_tips: '只支持最多三层目录，请优化目录结构',
